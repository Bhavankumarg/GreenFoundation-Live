        ...
        <>
            ...
            <Container fluid className='custom-policy-container-4'>
                <Container className='p-0 py-5 d-flex flex-column gap-3 text-md-center text-start'>
                    ...
                    <p>
                        The seed bill aims at making registration of varieties obligatory which was previously voluntary, creating a national register of seeds, facilitating the import and export of seeds, accommodating new ( lenient) regulations on GM crops, and increasing the space for private companies. The underlying intentions are to harmonize the seed law in India with other seed laws around the world.
                    </p>
