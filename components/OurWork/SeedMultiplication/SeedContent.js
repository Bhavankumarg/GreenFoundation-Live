        ...
        <>
            <Container fluid style={{ background: '#E0E9D3' }}>
                <Container className='text-center py-5'>
                    <p>
                        Seed multiplication is important as it helps enrich the biodiversity of a local area by making many indigenous seed varieties available to farmers who previously lacked access. It is also an income-generating scheme where individual farmers are compensated for their efforts in seed production.
                    </p>
