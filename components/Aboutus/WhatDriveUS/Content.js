        ...
        <>
            <Container fluid className='bg-custom-grey'>
                <Container className='py-5 text-center '>
                    ...
                    <p>When GREEN Foundation initially started its work, we became aware that much of the indigenous knowledge and oral tradition had been lost within a few short decades. Moreover, farmers had lost a sense of pride in their own culture. This knowledge provided an invaluable understanding to sustainable practices that could greatly benefit the agricultural sector.</p>
                ...
                <Container>
                    ...
                    <Row className='yellow-lime-green-bg custom-drive-row text-white'>
                        ...
                        <Col className='p-md-4 p-2 text-white'>
                            <p className='text-white'>“We realized there was something wrong with this method of agriculture when the fertility of the soil began diminishing,” says Vijayamma, a farmer in Tamil Nadu, of the chemical farming methods her family used to practice until they were introduced to GREEN. For small-scale and marginal farmers like Vijayamma, this was particularly worrying, because land is their lifeline to food security.</p>
