        ...
        <>
            <Container fluid className='py-5' style={{ background: '#F5E7C9' }}>
                ...
                <Container className='p-4 ecomomic-custom-container text-center'>
                    ...
                    <p>These varieties are most often food crops that the farmer can then use for personal consumption. They have a natural resilience to local conditions and this means that farmers are less likely to lose their harvests to unexpected, extreme weather changes. This is essential, particularly in the state of Karnataka (where much of GREEN’s work is based), as it is the 2nd most drought prone area in India. In fact, studies show 68% of the country is vulnerable to drought. There is another advantage to the use of these indigenous seed varieties: they have lead to a revival of traditional Indian agricultural practices that are inherently sustainable.</p>
