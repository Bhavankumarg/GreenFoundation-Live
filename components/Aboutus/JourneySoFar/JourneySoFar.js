                ...
                <Container className='py-md-4 p-md-0 p-2'>
                    <Row className='w-100 p-0 mx-0'>
                        ...
                        <Col className='text-center w-100 pt-4 pt-md-0'>
                            <h2 className='border border-2 border-dark rounded-5 p-4 px-5 lh-base fs-3  w-100 fs-4'>Our work to empower the small scale and marginal farmers of India first began in 1994 with a simple effort to distribute indigenous seed varieties in and around the village of Thalli, Tamil Nadu. This soon turned into a growing biodiversity conservation programme which is central to our work ever since.</h2>
