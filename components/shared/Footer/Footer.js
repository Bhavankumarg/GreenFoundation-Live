        ...
        <>
            <Container fluid className='bg-black text-white py-4'>
                <Container className='p-0 w-100'>
                    <Row className='d-flex flex-lg-row flex-column gap-lg-0 gap-3'>
                        <Col className='d-flex flex-column align-items-start'>
                            <h5 className='border border-top-0 border-end-0 border-start-0 pb-2 d-block mb-3'>Sitemap </h5>
                            <Link href="/journey-so-far" className='text-decoration-none text-white footer-text w-100'>About Us</Link>
                        ...
                        <Col className='d-flex flex-column align-items-start'>
                            ...
                            <h6 className='footer-text'>#36, Vinayaka Layout, Bhoopasandra Main Road, Bhoopasandra, Bangalore – 560094</h6>
                        </Col>
                        <Col className='d-flex flex-column align-items-start'>
