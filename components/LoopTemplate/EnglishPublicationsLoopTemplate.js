            ...
            <div key={i / 2} className="row-english-loop-publication py-md-3 py-0">
                {rowItems.map((item) => (
                    <Row key={item.title} className="item-english-loop rounded-4">
                        ...
                        <Col>
                            <h4 className='english-publication-head-loop-font'>{item.title}</h4>
                            <p className='english-publication-para-loop-font'>{item.excerpt}</p>
                        </Col>
                        {item.pdfurl && (
                            ...
                            // <div className='english-publication-btn'>
                            //     <Link href={item.pdfurl} target='_blank' className='english-publication-btn-loop-font'>
                            //         View PDF version
                            //     </Link>
                            // </div>
                        )}
