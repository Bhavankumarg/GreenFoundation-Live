    ...
    <>
      ...
      <Container fluid style={bgImage}>
        <Container className="py-5">
          <Row
            className="text-md-start text-center shadow-lg px-0 py-2 d-inline-block rounded-3"
            style={{ background: " #2E6339;" }}
          >
            <Link
              href="/"
              className="d-flex flex-row align-items-center gap-2 text-decoration-none text-green fw-bold "
            >
        ...
        <Container
          className="h-50 d-flex text-center justify-content-center align-items-center"
          style={{ color: "#2E6339" }}
        >
          <Row>
